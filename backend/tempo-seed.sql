...
VALUES
    ...
    ('cOoL WATeR foR thE nIGHT', 6, 7, 'Hip Hop', 'hella (˃̣̣̥╭╮˂̣̣̥) ✧ ♡ ‧º·˚/cOoL WATeR foR thE nIGHT.mp3', '00:03:45', FALSE),
    ('MiNt cHoCoLaTe', 6, 7, 'Hip Hop', 'hella (˃̣̣̥╭╮˂̣̣̥) ✧ ♡ ‧º·˚/MiNt cHoCoLaTe.mp3', '00:04:10', TRUE),
    ('JoEys song ༼つ ◕_◕ ༽つ', 6, 7, 'Hip Hop', 'hella (˃̣̣̥╭╮˂̣̣̥) ✧ ♡ ‧º·˚/JoEys song ༼つ ◕_◕ ༽つ.mp3', '00:03:55', FALSE),
    ('BiG IsLaND jazz hOUr', 6, 7, 'Hip Hop', 'hella (˃̣̣̥╭╮˂̣̣̥) ✧ ♡ ‧º·˚/BiG IsLaND jazz hOUr.mp3', '00:04:25', FALSE),
    ('LONG in the tOOth', 6, 7, 'Hip Hop', 'hella (˃̣̣̥╭╮˂̣̣̥) ✧ ♡ ‧º·˚/LONG in the tOOth.mp3', '00:04:00', TRUE),
    ('PrAisE nIgHt BluES InteRLUde', 6, 7, 'Hip Hop', 'hella (˃̣̣̥╭╮˂̣̣̥) ✧ ♡ ‧º·˚/PrAisE nIgHt BluES InteRLUde.mp3', '00:03:50', FALSE),
    ...
    ('silence STArEs me down', 6, 7, 'Hip Hop', 'hella (˃̣̣̥╭╮˂̣̣̥) ✧ ♡ ‧º·˚/silence STArEs me down.mp3', '00:03:50', TRUE),
    ('VOoDOo BOogie', 6, 7, 'Hip Hop', 'hella (˃̣̣̥╭╮˂̣̣̥) ✧ ♡ ‧º·˚/VOoDOo BOogie.mp3', '00:04:15', TRUE),
    ('siGiL aNd the MaZE ✼ ҉ ✼ ҉', 6, 7, 'Hip Hop', 'hella (˃̣̣̥╭╮˂̣̣̥) ✧ ♡ ‧º·˚/siGiL aNd the MaZE ✼ ҉ ✼ ҉.mp3', '00:04:05', FALSE);
