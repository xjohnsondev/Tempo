...
VALUES
    ...
    ('Speed Demon', 1, 1, 'Pop', 'path/to/speeddemon.mp3', '00:04:01', FALSE),
    ('Liberian Girl', 1, 1, 'Pop', 'path/to/liberiangirl.mp3', '00:03:52', FALSE),
    ('Just Good Friends', 1, 1, 'Pop', 'path/to/justgoodfriends.mp3', '00:04:08', FALSE),
    ...
    ('I Just Can''t Stop Loving You', 1, 1, 'Pop', 'path/to/ijustcantstoplovingyou.mp3', '00:04:13', FALSE),
    ('Dirty Diana', 1, 1, 'Pop', 'path/to/dirtydiana.mp3', '00:04:41', FALSE),
    ('Smooth Criminal', 1, 1, 'Pop', 'path/to/smoothcriminal.mp3', '00:04:17', FALSE),
    ...
    ('Within', 2, 2, 'Electronic', 'path/to/within.mp3', '00:03:48', FALSE),
    ('Instant Crush', 2, 2, 'Electronic', 'path/to/instantcrush.mp3', '00:05:37', FALSE),
    ('Lose Yourself to Dance', 2, 2, 'Electronic', 'path/to/loseyourselftodance.mp3', '00:05:53', FALSE),
    ('Touch', 2, 2, 'Electronic', 'path/to/touch.mp3', '00:08:18', FALSE),
    ('Get Lucky', 2, 2, 'Electronic', 'path/to/getlucky.mp3', '00:06:09', FALSE),
    ('Beyond', 2, 2, 'Electronic', 'path/to/beyond.mp3', '00:04:50', FALSE),
    ('Motherboard', 2, 2, 'Electronic', 'path/to/motherboard.mp3', '00:05:41', FALSE),
    ...
    ('Contact', 2, 2, 'Electronic', 'path/to/contact.mp3', '00:06:21', FALSE),

    -- Songs from "The Miseducation of Lauryn Hill"
    ('Intro', 3, 3, 'Hip Hop', 'path/to/intro.mp3', '00:00:47', FALSE),
    ('Lost Ones', 3, 3, 'Hip Hop', 'path/to/lostones.mp3', '00:05:33', TRUE),
    ('Ex-Factor', 3, 3, 'Hip Hop', 'path/to/exfactor.mp3', '00:05:26', TRUE),
    ('To Zion', 3, 3, 'Hip Hop', 'path/to/tozion.mp3', '00:06:09', FALSE),
    ('Doo Wop (That Thing)', 3, 3, 'Hip Hop', 'path/to/doowop.mp3', '00:05:20', TRUE),
    ('Superstar', 3, 3, 'Hip Hop', 'path/to/superstar.mp3', '00:04:57', FALSE),
    ('Final Hour', 3, 3, 'Hip Hop', 'path/to/finalhour.mp3', '00:04:16', TRUE),
    ('When It Hurts So Bad', 3, 3, 'Hip Hop', 'path/to/whenithurtssobad.mp3', '00:05:42', FALSE),
    ('I Used to Love Him', 3, 3, 'Hip Hop', 'path/to/iusedtolovehim.mp3', '00:05:39', FALSE),
    ('Forgive Them Father', 3, 3, 'Hip Hop', 'path/to/forgivethemfather.mp3', '00:05:15', FALSE),
    ('Every Ghetto, Every City', 3, 3, 'Hip Hop', 'path/to/everyghettoeverycity.mp3', '00:05:14', TRUE),
    ('Nothing Even Matters', 3, 3, 'Hip Hop', 'path/to/nothingevenmatters.mp3', '00:05:50', FALSE),
    ('Everything Is Everything', 3, 3, 'Hip Hop', 'path/to/everythingiseverything.mp3', '00:04:53', TRUE),
    ('The Miseducation of Lauryn Hill', 3, 3, 'Hip Hop', 'path/to/themiseducationoflaurynhill.mp3', '00:03:55', FALSE),
    ('Can''t Take My Eyes Off of You', 3, 3, 'Hip Hop', 'path/to/canttakemyeyesoffofyou.mp3', '00:03:41', FALSE),
    ('Tell Him', 3, 3, 'Hip Hop', 'path/to/tellhim.mp3', '00:04:40', FALSE),
    ...
    ('Thriller', 1, 4, 'Pop', 'path/to/thriller.mp3', '00:05:57', FALSE),
    ('Beat It', 1, 4, 'Rock', 'path/to/beatit.mp3', '00:04:18', TRUE),
    ('Billie Jean', 1, 4, 'Pop', 'path/to/billiejean.mp3', '00:04:54', FALSE),
    ('Human Nature', 1, 4, 'Pop', 'path/to/humannature.mp3', '00:04:06', FALSE),
    ('P.Y.T. (Pretty Young Thing)', 1, 4, 'Pop', 'path/to/pyt.mp3', '00:03:58', FALSE),
    ...
    ('Nangs', 4, 5, 'Pop', 'path/to/nangs.mp3', '00:01:47', FALSE),
    ('The Moment', 4, 5, 'Pop', 'path/to/themoment.mp3', '00:04:15', FALSE),
    ('Yes I''m Changing', 4, 5, 'Pop', 'path/to/yesimchanging.mp3', '00:04:30', FALSE),
    ('Eventually', 4, 5, 'Pop', 'path/to/eventually.mp3', '00:05:19', FALSE),
    ('Gossip', 4, 5, 'Pop', 'path/to/gossip.mp3', '00:00:55', FALSE),
    ('The Less I Know the Better', 4, 5, 'Pop', 'path/to/thelessiknowthebetter.mp3', '00:03:36', FALSE),
    ('Past Life', 4, 5, 'Pop', 'path/to/pastlife.mp3', '00:03:48', FALSE),
    ('Disciples', 4, 5, 'Pop', 'path/to/disciples.mp3', '00:01:48', FALSE),
    ('Cause I''m a Man', 4, 5, 'Pop', 'path/to/causeimaman.mp3', '00:04:01', FALSE),
    ('Reality in Motion', 4, 5, 'Pop', 'path/to/realityinmotion.mp3', '00:04:12', FALSE),
    ('Love/Paranoia', 4, 5, 'Pop', 'path/to/loveparanoia.mp3', '00:03:06', FALSE),
    ('New Person, Same Old Mistakes', 4, 5, 'Pop', 'path/to/newpersonsameoldmistakes.mp3', '00:06:03', FALSE);
